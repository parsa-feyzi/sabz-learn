function Logo2({ styles }: { styles?: string }) {
  return (
    // <svg
    //   className={styles ? styles : "h-10 sm:h-12 lg:h-13"}
    ...
    //   ></polygon>
    // </svg>
    <div className={styles ? styles : "h-10 sm:h-12 lg:h-13 flex items-center content-center gap-3"}>
      <img src="/img/logo2.png" className="h-10 sm:h-12 lg:h-13" alt="" />
      <div className="font-[dana-xb] text-3xl">
        <span className="font-[dana-xb] text-prim">بــــی‌</span>
        لـرن
      </div>
    </div>
  );
